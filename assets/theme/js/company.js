...
function loadData() {
    var html = "<table class='table table-striped' id='sellertable'><thead><tr><th scope='col'>Name</th><th scope='col'>Role</th><th scope='col'>Live Categories</th><th scope='col'>Contact Name</th><th scope='col'>Contact Number</th><th scope='col'>Email</th><th scope='col'>Live Cities</th><th scope='col'>Website</th></thead><tbody>";
    ...
    $.getJSON(JsonData, function (stores) {
        $.each(stores, function (i, store) {
            ...
            html += "<tr><td>" + sellername + "</td><td>" + domain + "</td><td>" + categories + "</td><td>" + contact + "</td><td>" + contactno + "</td><td>" + email + "</td><td>" + cities + "</td><td>" + website + "</td></tr>";
        });
